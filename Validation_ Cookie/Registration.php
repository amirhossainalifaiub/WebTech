                        ...
                        <table style="width:25%;">
                            ...
                            <tr>
                                    ...
                                    if(empty($_POST["fname"]))
                                {
                                    ...
                                    setcookie("fname",$fname,time()+60*60*24*30,"/");
                                    echo isset($_COOKIE['fname']) ? $_COOKIE['fname'] : "";
                            ...
                            <tr>
                                    ...
                                    if(empty($_POST["lname"]))
                                {
                                    ...
                                    setcookie("lname",$lname,time()+60*60*24*30,"/");
                                    echo isset($_COOKIE['lname']) ? $_COOKIE['lname'] : "";
                            ...
                            <tr>
                                    ...
                                    if(empty($_POST["Gender"]))
                                {
                                    ...
                                    echo isset($_COOKIE['Gender']) ? $_COOKIE['Gender'] : "";
                            ...
                            <tr>
                                ...
                                <?php 
                                     ...
                                     if(empty($_POST["mnam"]))
                                 {
                                    ...
                                    $_SESSION['mnam'] = $_POST['mnam'];
                                    if(isset($_SESSION['mnam']))
